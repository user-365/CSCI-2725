% manage PDFs (esp. screen-reading tags)
...
% - fix that one thing you emailed prof about
...
% source: https://tex.stackexchange.com/a/448386
\newcommand*\myphantomrel[1]{\mathrel{\phantom{#1}}}

% word/phrase inline highlighting (for final answers)
% source: https://tex.stackexchange.com/a/234175 (less SLOW than tikz method on same page?)
