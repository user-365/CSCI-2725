...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item How many recursive calls will be made for function call \verb|fun(7)|?
            ...
            \hspace*{\fill} \textbf{Answer:} Seventeen (17) function calls including first call (\verb|fun(7)|). \\
        ...
        \item How many recursive calls will be made for function call \verb|fun(8)|?
            ...
            \hspace*{\fill} \textbf{Answer:} Four (4) function calls including first call (\verb|fun(8)|). \\
        ...
        \item Do you see any problem in the above function?
            ...
            \hspace*{\fill} \textbf{Answer:} Yes, there is a problem; the function should not have wildly different complexity for its inputs.
